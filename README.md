...
[![Test](https://github.com/NpoolPlatform/ledger-manager/actions/workflows/main.yml/badge.svg?branch=master)](https://github.com/NpoolPlatform/ledger-manager/actions/workflows/main.yml)
...
* make ledger-manager ```单独编译服务```
* make ledger-manager-image ```单独生成服务镜像```
