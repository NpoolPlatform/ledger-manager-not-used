...
func (pu *ProfitUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *ProfitUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (puo *ProfitUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *ProfitUpdateOne {
