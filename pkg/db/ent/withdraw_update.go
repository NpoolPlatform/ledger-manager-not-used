...
func (wu *WithdrawUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *WithdrawUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (wuo *WithdrawUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *WithdrawUpdateOne {
