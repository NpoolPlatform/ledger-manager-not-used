...
func (muu *MiningUnsoldUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *MiningUnsoldUpdate {
	muu.modifiers = append(muu.modifiers, modifiers...)
	return muu
}
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (muuo *MiningUnsoldUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *MiningUnsoldUpdateOne {
	muuo.modifiers = append(muuo.modifiers, modifiers...)
	return muuo
}
...
func (muuo *MiningUnsoldUpdateOne) sqlSave(ctx context.Context) (_node *MiningUnsold, err error) {
	...
	_spec.Modifiers = muuo.modifiers
