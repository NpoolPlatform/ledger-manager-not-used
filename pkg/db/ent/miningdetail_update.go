...
func (mdu *MiningDetailUpdate) Modify(modifiers ...func(u *sql.UpdateBuilder)) *MiningDetailUpdate {
...
// Modify adds a statement modifier for attaching custom logic to the UPDATE statement.
func (mduo *MiningDetailUpdateOne) Modify(modifiers ...func(u *sql.UpdateBuilder)) *MiningDetailUpdateOne {
...
func (mduo *MiningDetailUpdateOne) sqlSave(ctx context.Context) (_node *MiningDetail, err error) {
	...
	_spec.Modifiers = mduo.modifiers
