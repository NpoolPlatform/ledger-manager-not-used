...
const (
	// Label holds the string label denoting the miningdetail type in the database.
	Label = "mining_detail"
	...
	// Table holds the table name of the miningdetail in the database.
	Table = "mining_details"
)

// Columns holds all SQL columns for miningdetail fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
