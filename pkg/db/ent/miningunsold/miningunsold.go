...
const (
	// Label holds the string label denoting the miningunsold type in the database.
	Label = "mining_unsold"
	...
	// Table holds the table name of the miningunsold in the database.
	Table = "mining_unsolds"
)

// Columns holds all SQL columns for miningunsold fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
