...
const (
	// Label holds the string label denoting the mininggeneral type in the database.
	Label = "mining_general"
	...
	FieldToUser = "to_user"
	// Table holds the table name of the mininggeneral in the database.
	Table = "mining_generals"
)

// Columns holds all SQL columns for mininggeneral fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
