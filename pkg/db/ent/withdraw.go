...
func (*Withdraw) scanValues(columns []string) ([]interface{}, error) {
	...
	for i := range columns {
		...
		case withdraw.FieldID, withdraw.FieldAppID, withdraw.FieldUserID, withdraw.FieldCoinTypeID, withdraw.FieldAccountID, withdraw.FieldPlatformTransactionID, withdraw.FieldFromOldID:
...
func (w *Withdraw) String() string {
	...
	builder.WriteString(fmt.Sprintf("%v", w.FromOldID))
	builder.WriteByte(')')
