...
const (
	// Label holds the string label denoting the miningprofitunsold type in the database.
	Label = "mining_profit_unsold"
	...
	// Table holds the table name of the miningprofitunsold in the database.
	Table = "mining_profit_unsolds"
)

// Columns holds all SQL columns for miningprofitunsold fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
