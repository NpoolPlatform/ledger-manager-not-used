...
const (
	// Label holds the string label denoting the miningprofitdetail type in the database.
	Label = "mining_profit_detail"
	...
	// Table holds the table name of the miningprofitdetail in the database.
	Table = "mining_profit_details"
)

// Columns holds all SQL columns for miningprofitdetail fields.
var Columns = []string{
	FieldID,
	FieldCreatedAt,
	FieldUpdatedAt,
