...
import (
	...
	npool "github.com/NpoolPlatform/message/npool/ledger/mgr/v1/general"
...
type handler func(context.Context, npool.LedgerGeneralClient) (cruder.Any, error)
...
func withCRUD(ctx context.Context, handler handler) (cruder.Any, error) {
	...
	cli := npool.NewLedgerGeneralClient(conn)

	return handler(_ctx, cli)
}

func CreateGeneral(ctx context.Context, in *npool.GeneralReq) (*npool.General, error) {
	info, err := withCRUD(ctx, func(_ctx context.Context, cli npool.LedgerGeneralClient) (cruder.Any, error) {
...
func CreateGenerals(ctx context.Context, in []*npool.GeneralReq) ([]*npool.General, error) {
	infos, err := withCRUD(ctx, func(_ctx context.Context, cli npool.LedgerGeneralClient) (cruder.Any, error) {
